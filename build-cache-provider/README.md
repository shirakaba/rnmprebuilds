Based on Expo's excellent [with-github-remote-build-cache-provider](https://github.com/expo/examples/tree/master/with-github-remote-build-cache-provider) example (no licence, but I've added the main Expo licence to the repo root at `LICENSE-expo.txt`). All I've done is:
